  ...
  const gridItems = [
    ...
    [
      ...
      { label: "Item 4" },
      {
        ...
        children: (
          <AnimatedContainer>
            <Link to="/museum" {...stylex.props(styles.link)}>
              {" "}
              Rijksmuseum{" "}
            </Link>
          </AnimatedContainer>
    ...
    [
      ...
      { label: " 7" },
      {
        ...
        children: (
          <AnimatedContainer>
            <Link
              to="https://29kumait.github.io/Out-Of-Sync/"
              {...stylex.props(styles.link)}
            >
              {" "}
              Assignment 45 in the Side{" "}
            </Link>
          </AnimatedContainer>
        ),
      },
    ...
    [
      { isLink: true, to: "/starred", label: "StarredPage" },
      { label: "Item End" },
    ],
  ];
      ...
      <div>
        ...
        <ImageSwitcher
          ...
          stylexProps={stylex.props(
            styles.logo,
            styles.logoFly,
            isAnimated && styles.combinedAnimation,
          )}
        />
      </div>
